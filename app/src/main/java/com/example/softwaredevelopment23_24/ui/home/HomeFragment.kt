...
class HomeFragment : Fragment() {
    ...
    private val tasks = listOf(
        ...
        listOf("Meditate (10 min)",1,15,"Meditation helps the mind reduce the effects of anxiety, increase self-awareness, and promotes balance!", 10),
        listOf("Literature (10 min)",1,15,"Reading stimulates the mind and lets you escape from day to day worries!", 10),
        listOf("Hone Skills (15 min)",1,15,"Practicing your favorite hobby makes you feel accomplished and helps boost your self-esteem!", 15),
    )
